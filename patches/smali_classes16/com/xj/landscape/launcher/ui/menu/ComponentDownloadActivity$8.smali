# SingleReleaseRunnable — background: GET GitHub Releases API for a specific tag
#   (e.g. /releases/tags/kimchi-drivers), parse single release JSONObject,
#   strip "tmp[random]_" prefix from asset names, use browser_download_url,
#   populate mAllNames/mAllUrls, post $2 (showCategories on UI thread)
.class final Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity$8;
...
.method constructor <init>(Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity$8;->this$0:Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity;
    iput-object p2, p0, Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity$8;->val$url:Ljava/lang/String;
    return-void
.end method
...
.method public run()V
    ...
    # Parse:  v6=root JSONObject→assets JSONArray  v7=asset count  v8=asset index
    # Inner:  v9=asset JSONObject  v10=asset name (stripped)  v11=indexOf temp
    # v5 reused as browser_download_url after responseStr consumed into JSONObject

    iget-object v0, p0, Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity$8;->this$0:Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity;

    :try_start

    # open HTTP connection to val$url
    iget-object v1, p0, Lcom/xj/landscape/launcher/ui/menu/ComponentDownloadActivity$8;->val$url:Ljava/lang/String;
    ...
    # parse root JSONObject, extract "assets" array into v6
    new-instance v6, Lorg/json/JSONObject;
    invoke-direct {v6, v5}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V
    # v5 now free — reused as browser_download_url in inner loop
    ...
    # strip "tmp[random]_" prefix if present: if starts with "tmp", find first '_' and substring
    const-string v1, "tmp"
    ...
    :accept_asset
    # v5 = browser_download_url
    const-string v1, "browser_download_url"
    invoke-virtual {v9, v1}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;
    move-result-object v5

    # add stripped name to mAllNames, url to mAllUrls
